...
export interface StoringIndividualVehicle {
  vehicle_id: number;
  frame_no: string;
  license_plate: string;
...
export interface StoringIndividualVehicleConfig {
...
export interface IndividualVehicle extends ApiStatus {
  response: {
    vehicle: StoringIndividualVehicle;
    vehicleConfig: StoringIndividualVehicleConfig;
  };
}
